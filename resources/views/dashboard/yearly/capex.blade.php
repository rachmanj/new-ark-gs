    ...
    <div class="table-responsive">
      <table class="table m-0 table-striped">
        ...
        <tbody>
          ...
          <tr>
            <th>Total</th>
            <th class="text-right">{{ number_format($data['capex']['sent_total'] / 1000, 2) }}</th>
            <th class="text-right">{{ number_format($data['capex']['budget_total'] / 1000, 2) }}</th>
            <th class="text-right">{{ number_format($data['capex']['percentage'] * 100, 2) }}</th>
          </tr>
        </tbody>
      </table>
    </div>
