      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            @can('upload_data')
            <a href="{{ route('incoming.truncate') }}" class="btn btn-sm btn-danger float-right {{ $is_data === 1 ? "" : "disabled" }}" onclick="return confirm('Are You sure You want to delete all records?')"><i class="fas fa-trash"></i> Truncate Table</a>
            ...
            <a href="{{ route('incoming.export_this_month') }}" class="btn btn-sm btn-info float-right {{ $is_data === 1 ? "" : "disabled" }}"><i class="fas fa-save"></i> Export to Excel</a>
          </div>
          <div class="card-body">
