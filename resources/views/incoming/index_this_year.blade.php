      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            @endif
            <a href="{{ route('incoming.index') }}">This Month</a> | 
            <a href="#"><b>THIS YEAR</b></a>
            <a href="{{ route('incoming.export_this_year') }}" class="btn btn-sm btn-info float-right"><i class="fas fa-save"></i> Export to Excel</a>
          </div>
          <div class="card-body">
  ...
  <script>
    $(function () {
      $("#incoming").DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('incoming.data.this_year') }}',
        columns: [
