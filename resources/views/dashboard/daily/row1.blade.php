...
<div class="col-12 col-sm-6 col-md-4">
  <div class="info-box mb-3">
    <span class="info-box-icon {{ $po_sent_vs_grpo >= 100 ? 'bg-success' : 'bg-danger' }} elevation-1"><i class="fas {{ $po_sent_vs_grpo >= 80 ? 'fa-thumbs-up' : 'fa-frown' }}"></i></span>
    <div class="info-box-content">
...
<div class="col-12 col-sm-6 col-md-4">
  <div class="info-box mb-3">
    <span class="info-box-icon {{ $npi <= 1 ? 'bg-success' : 'bg-danger' }} elevation-1"><i class="fas {{ $npi <= 80 ? 'fa-thumbs-up' : 'fa-frown' }}"></i></span>
    <div class="info-box-content">
